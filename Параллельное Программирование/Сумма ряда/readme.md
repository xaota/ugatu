...
### Запустить первые 2 расчёта с 2 и 3 миллионами элементов
### Запустить первые 2 расчёта с флагом `-ffast-math` вместо флага `-lm`, а также с 2 и 3 миллионами элементов
### После флага `-pedantic` выставить флаги оптимизации `-O1`, `-O2`, `-O3` и для icc также флаг `-fast`, а для gcc флаг `-lrt` (по желанию).
